...
public class DefectPixelInterpolation {
	...
	public Grid2D interpolateSpectral(Grid2D image, Grid2D mask, int maxIter, boolean zeroPadding)
	{
		...
		for(int i = 0; i < maxIter; i++)
		{
			...
			else
			{
				...
				Complex val = ((GVal.mul(WVal_00.getConjucate())).sub(GVal.getConjugate().mul(WVal_twice)).mul(dim[0]*dim[1]));
				val = val.div(WVal_00.getMagn()*WVal_00.getMagn()-WVal_twice.getMagn()*WVal_twice.getMagn());
				
				Complex res_slt1=  FHatNextVal_slt1.add(val);
				Complex res_slt2=  FHatNextVal_slt2.add(val.getConjugate());
	...
	public static void main(String[] args) {
		...
		String filename = "C:/Users/Sohani/Documents/Desktop/eclipse/Reconstruction/CONRAD/src/edu/stanford/rsl/tutorial/dmip/testimg.bmp";
		String filenameMask = "C:/Users/Sohani/Documents/Desktop/eclipse/Reconstruction/CONRAD/src/edu/stanford/rsl/tutorial/dmip/mask.bmp";
